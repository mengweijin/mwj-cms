...
CREATE TABLE sys_job_type (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调度Job类型表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Job执行Cron表达式';
...
CREATE TABLE sys_job_log (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调度任务日志表';
