...
public class TreeUtils {
    ...
    public static <T> List<T> filterBeanByPid(List<T> list, String... parentIds) throws MwjCmsException {
        return filterBeanByRootId("id", "pid", list, parentIds);
    }

    public static <T> List<T> filterBeanByParentId(List<T> list, String... parentIds) throws MwjCmsException {
     ...
     */
    public static <E> List<E> filterBeanByRootId(String idName, String parentIdName, List<E> list, String... parentIds) throws MwjCmsException {
    ...
    public static <T> List<JSONObject> buildJsonBeanTreeByPid(List<T> list, String rootId) throws MwjCmsException {
        return buildJsonBeanTree(list, rootId, "id", "pid");
    }

    public static <T> List<JSONObject> buildJsonBeanTreeByParentId(List<T> list, String rootId) throws MwjCmsException {
     ...
     * @throws MwjCmsException
     */
    public static <E> List<JSONObject> buildJsonBeanTree(List<E> list, String rootId, String idName, String pidName) throws MwjCmsException {
