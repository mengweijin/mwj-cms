package com.mwj.cms.common.util.aes;
...
public final class AES {
	 ...
	 * @return
	 */
	public static String encrypt(final String password) throws MwjCmsException {
	 ...
	 * @return
	 */
	public static String encrypt(String password, String salt) throws MwjCmsException {
		try {
			...
			logger.error(e);
			throw new MwjCmsException(e.getMessage(), e);
		}
	}
	 ...
	 * @return
	 */
	public static String decrypt(String password) throws MwjCmsException {
	 ...
	 * @return
	 */
	public static String decrypt(String password, String salt) throws MwjCmsException {
		try{
